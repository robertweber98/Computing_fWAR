...
## and rSB for catchers
defense[ , c("Name", "Team", "Position", "Inn", "rSB")] -> defense 
...
# wRAA next
((full.df$wOBA_x - mean(full.df$wOBA_x)) / woba_scale) * full.df$PA  -> full.df$wRAA_x
...
# Fielding Runs
For fielding runs, fangraphs.com uses their UZR number, that which I am not able to calculate (see README).
But, for catchers it uses rSB
...
# WAR
- WAR = (Bat + BR + Fielding Runs + Positional Adjustment + League Adjustment +Replacement Runs) / (Runs Per Win)
